        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Visão consolidada de pesquisas, participação e indicadores de clima.
            </p>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        >
          <div className="mb-4">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Defina o período de criação das pesquisas e, se necessário, filtre por cliente.
            </p>
          </div>
        ...
        <div className="mb-6 grid gap-6 xl:grid-cols-2">
          <section className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Distribuição das pesquisas no período selecionado.
            </p>
          ...
          <section className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Relação entre convites gerados e convites efetivamente respondidos.
            </p>

            <div className="mt-6 grid grid-cols-2 gap-4">
              <Info
                titulo="Links gerados"
                valor={String(
                  dados.resumo
                    .totalConvites
                )}
            ...
            <p className="mt-4 text-xs leading-5 text-slate-400">
              A taxa de participação utiliza apenas links individuais. Respostas recebidas pelo link público não entram no cálculo de participação por convite.
            </p>
          </section>
        </div>

        <section className="mb-6 rounded-3xl bg-white shadow-sm ring-1 ring-slate-200">
          <div className="border-b border-slate-100 p-5 sm:p-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Visão executiva da adesão e dos resultados de cada empresa.
            </p>
          </div>
        ...
        <section className="rounded-3xl bg-white shadow-sm ring-1 ring-slate-200">
          <div className="border-b border-slate-100 p-5 sm:p-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Detalhamento das pesquisas consideradas neste relatório.
            </p>
          </div>
