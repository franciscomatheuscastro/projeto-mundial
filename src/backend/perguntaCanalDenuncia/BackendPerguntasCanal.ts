...
export async function obterPerguntaCanalPorId(
  id: string
) {
  await validarMundial();

  return RepositorioPerguntaCanalDenuncia.obterPorId(
    id
  );
}
...
export async function obterPerguntasCanalAtivasPorCliente(
  ...
  return RepositorioPerguntaCanalDenuncia.obterAtivasPorCliente(
    clienteId
  );
}
...
export async function salvarPerguntaCanal(
  ...
  return RepositorioPerguntaCanalDenuncia.salvar(
    dados
  );
}

export async function excluirPerguntaCanal(
  id: string
) {
  await validarMundial();

  return RepositorioPerguntaCanalDenuncia.excluir(
    id
  );
}